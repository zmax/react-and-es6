...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helloWorld = __webpack_require__(54);

	var _helloWorld2 = _interopRequireDefault(_helloWorld);

	var _cartitem = __webpack_require__(90);
	...
	_reactDom2.default.render(_react2.default.createElement(_cartitem2.default, cartProps), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(108);
	...
	var HelloWorld = function (_React$Component) {
	    ...
	    function HelloWorld(props) {
	        ...
	        _this.shouldComponentUpdate = function () {
	            return _reactAddonsPureRenderMixin2.default.shouldComponentUpdate();
	        };
	        return _this;
	    }
	...
	var Button = function (_React$Component) {
	    ...
	    _createClass(Button, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: btnClass, style: btnStyle, onClick: this.props.onClick },
	                this.state.label
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartItem = (_temp = _class = function (_React$Component) {
	    ...
	    function CartItem(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CartItem).call(this, props));

	        _this.state = {
	            qty: _this.props.initialQty,
	            total: 0
	        };
	        _this.totalStyle = {
	            marginTop: 0,
	        ...
	        _this.increaseQty = function () {
	            _this.setState({ qty: _this.state.qty + 1 }, _this.culateTotal);
	        };

	        _this.decreaseQty = function () {
	            _this.setState({ qty: Math.max(_this.state.qty - 1, 0) }, _this.culateTotal);
	        };

	        _this.onHeartBeat = function () {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-xs-12 col-sm-12' },
	                        _react2.default.createElement(_image2.default, { source: this.props.image, responsive: true }),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_button2.default, { label: '+', onClick: this.increaseQty })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-xs-4 col-sm-4' },
	                        _react2.default.createElement(
	                            'h2',
	                            { className: 'text-center', style: this.totalStyle },
	                            '$',
	                            this.state.total
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-xs-4 col-sm-4' },
	                        _react2.default.createElement(_button2.default, { label: '-', onClick: this.decreaseQty })
	                    )
	                ),
	                _react2.default.createElement('hr', null),
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-xs-12 col-sm-12 text-center' },
	                    _react2.default.createElement(_counter2.default, { hr: this.props.hr, onHeartBeat: this.onHeartBeat })
	                ),
	                _react2.default.createElement(_helloWorld2.default, { phrase: 'ES6' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountBeats = (0, _heartbeat.HeartBeat)(_class = function (_React$Component) {
	    _inherits(CountBeats, _React$Component);

	    function CountBeats(props) {
	        _classCallCheck(this, CountBeats);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CountBeats).call(this, props));

	        _this.state = { beats: 0 };
	        return _this;
	    }

	    _createClass(CountBeats, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HeartBeat = exports.HeartRate = undefined;
	...
	var HeartRate = exports.HeartRate = 60;
	/**
	 ...
	 *
	 */
	var HeartBeat = exports.HeartBeat = function HeartBeat(ComposedComponent) {
	    var _class, _temp2;
	    ...
	    return _temp2 = _class = function (_ComposedComponent) {
	        ...
	        function _class() {
	            ...
	            return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.interval = null, _this.state = { hr: HeartRate, ticks: 0 }, _temp), _possibleConstructorReturn(_this, _ret);
	        }

	        _createClass(_class, [{
	            key: 'updateHeartRate',
	            value: function updateHeartRate(hr) {
	            ...
	            value: function componentWillMount() {
	                ...
	                if (_get(Object.getPrototypeOf(_class.prototype), 'componentWillMount', this)) _get(Object.getPrototypeOf(_class.prototype), 'componentWillMount', this).call(this);
	            }
	        }, {
	            key: 'componentWillUnmount',
	            value: function componentWillUnmount() {
	                window.cancelAnimationFrame(this.interval);
	                if (_get(Object.getPrototypeOf(_class.prototype), 'componentWillUnmount', this)) _get(Object.getPrototypeOf(_class.prototype), 'componentWillUnmount', this).call(this);
	            }
	        }, {
	            key: 'componentDidMount',
	            value: function componentDidMount() {
	                ...
	                if (_get(Object.getPrototypeOf(_class.prototype), 'componentDidMount', this)) _get(Object.getPrototypeOf(_class.prototype), 'componentDidMount', this).call(this);
	            }
	        }, {
	            key: 'update',
	            value: function update() {
	            ...
	            value: function reunder() {
	                _react2.default.createElement(ComposedComponent, _extends({}, props, state));
	            }
	        }]);

	        return _class;
	    }(ComposedComponent), _class.propTypes = { hr: _react2.default.PropTypes.number }, _class.defaultProps = { hr: HeartRate }, _temp2;
	};
	...
	var Image = (_temp = _class = function (_React$Component) {
	    ...
	    _createClass(Image, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('img', { className: imgClass, src: this.props.source });
	        }
	    }]);
